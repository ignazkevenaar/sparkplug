export default {
  ...
  default: {
    background: {
      default: ['bg-control-background-base', 'active:bg-control-background-base/50'],
      outline: [
  ...
  red: {
    background: {
      default: ['bg-control-background-red-dim', 'active:bg-control-background-red/50'],
      outline: [
        'bg-control-background-red-dim',
        'active:bg-control-background-red-dim/50',
        'ring-control-background-red'
      ],
      fill: ['bg-control-background-red-highlight', 'active:bg-control-background-red-highlight/75']
    },
    foreground: {
  ...
  yellow: {
    background: {
      default: ['bg-control-background-yellow-dim', 'active:bg-control-background-yellow/50'],
      outline: [
  ...
  green: {
    background: {
      default: ['bg-control-background-green-dim', 'active:bg-control-background-green/50'],
      outline: [
  ...
  blue: {
    background: {
      default: ['bg-control-background-blue-dim', 'active:bg-control-background-blue/50'],
      outline: [
  ...
  pink: {
    background: {
      default: ['bg-control-background-pink-dim', 'active:bg-control-background-pink/50'],
      outline: [
