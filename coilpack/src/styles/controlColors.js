export default {
    ...
    default: {
        ...
        foreground: {
            default: [
                "text-control-foreground-base"
            ],
            highlight: [
                "text-control-foreground-base-highlight"
            ],
            dim: [
                "text-control-foreground-base-dim"
            ]
        }
    },
    black: {
    ...
    red: {
        ...
        foreground: {
            default: [
                "text-control-foreground-red"
            ],
            highlight: [
                "text-control-foreground-red-highlight"
            ],
            dim: [
                "text-control-foreground-red-dim"
            ]
        }
    },
    yellow: {
        ...
        foreground: {
            default: [
                "text-control-foreground-yellow"
            ],
            highlight: [
                "text-control-foreground-yellow-highlight"
            ],
            dim: [
                "text-control-foreground-yellow-dim"
            ]
        }
    },
    green: {
        ...
        foreground: {
            default: [
                "text-control-foreground-green"
            ],
            highlight: [
                "text-control-foreground-green-highlight"
            ],
            dim: [
                "text-control-foreground-green-dim"
            ]
        }
    },
    blue: {
        ...
        foreground: {
            default: [
                "text-control-foreground-blue"
            ],
            highlight: [
                "text-control-foreground-blue-highlight"
            ],
            dim: [
                "text-control-foreground-blue-dim"
            ]
        }
    },
    pink: {
        ...
        foreground: {
            default: [
                "text-control-foreground-pink"
            ],
            highlight: [
                "text-control-foreground-pink-highlight"
            ],
            dim: [
                "text-control-foreground-pink-dim"
            ]
        }
    }
};
