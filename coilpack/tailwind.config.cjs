  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        button: {
          background: {
            DEFAULT: themeCol('button-background'),
            hover: themeCol('button-background-hover')
          }
        },
        dialog: {
          background: themeCol('dialog-background'),
          backdrop: themeCol('dialog-backdrop'),
          foreground: themeCol('dialog-foreground')
        },
        controls: {
